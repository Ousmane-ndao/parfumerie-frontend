      ...
      <div className="container-x py-14 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <div className="mt-5 flex gap-3">
            <a
              ...
              aria-label="Facebook"
              className="rounded-full border border-cream/30 p-2.5 hover:bg-cream/10 transition-colors"
            >
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-cream/80">
            <li>
              <Link to="/catalogue" className="hover:text-rose transition-colors">
                Catalogue
              </Link>
            </li>
            ...
            <li>
              <Link to="/a-propos" className="hover:text-rose transition-colors">
                À propos
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/faq" className="hover:text-rose transition-colors">
                FAQ
              </Link>
            </li>
            <li>
              <Link to="/conditions" className="hover:text-rose transition-colors">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-cream/80">
            ...
            <li className="flex items-start gap-2">
              <Clock className="h-4 w-4 mt-0.5 shrink-0" /> {site.hours}
            </li>
            <li className="flex items-start gap-2">
            ...
            <li>
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-whatsapp px-4 py-2 text-sm font-medium text-white hover:opacity-90 transition-opacity"
              >
                WhatsApp Business
              </a>
            </li>
